...
<body>
    ...
    <div class="container">
        <div class="infoPrincipal">
            ...
            <h1>Transacciones Bancarias A Cuentas de Terceros</h1><br>
            <div class="modContent">
                <div class="container">
                    <?php 
                    $cuentas = CuentasControlador::ctrMostrarcuentashabilitadas($_SESSION['id']);
                    $cuentasTerceros = CuentasControlador::ctrMostrarcuentashabilitadasterceros($_SESSION['id']);
                    if (count($cuentas) == 0) {
                    ?>
                    <p class="text-center">
                        <strong class="text-success">No dispone de una cuenta</strong><br>   
                        <span class="">Actualmente  usted no dispone de ninguna cuenta creada o habilitada  y no es posible hacer transferencias a cuentas de terceros.</span>                             
                    </p>
                    <?php
                    }elseif(count($cuentasTerceros) == 0){
                        ?>
                        <p class="text-center">
                            <strong class="text-success">No existen cuentas de terceros habilitadas</strong><br>   
                            <span class="">Usted cuenta con la cuenta de origen pero no existe una cuenta de tercero habilitada para el destino.</span>                             
                        </p>
                    <?php
                    }else{
                    ?>
                    <form class="mt-10" id="formTerceros" action="" method="post">
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <select name="cdestino" id="cdestino" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                        <option value="" default>Seleccione de la lista</option>
                                        <?php foreach ($cuentasTerceros as $valor){?>
                                            <option value="<?= $valor['id']?>"><?= $valor['numero'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <input id="btn-trasferirT" type="submit" class="btn btn-success" value="Transferir">                            
                        </div>
                    </form>
                    <?php
                    }
